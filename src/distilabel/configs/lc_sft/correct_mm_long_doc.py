...
gpt_oss_prompt_sampler_config = PromptSamplerConfig(
    distributions={
        'system_prompt': CategoricalDist(
            choices=[
                ('/mnt/nfs/austin_shared/mp_data_gen/distilabel/prompts/lc_sft/mm_long_answer_to_claims.txt', 1.0)
            ],
        ),
    },
)
...
CACHE_DIR = Path('/mnt/nfs/austin_shared/mp_data_gen/distilabel/out/correct_mm_long_doc')
...
CLAIMS_SUPPORTED_THRESHOLD = 0.0
PIPELINE_NAME = 'correct_mm_long_doc_v1'
    ...
    Stage(
        lm_configs=[
            LMConfig(
                ...
                system_template_path='distilabel/prompts/lc_sft/evidence_in_chunks_mm_long_doc.txt',
                prompt_sampler_config=PromptSamplerConfig(),
            ),
        ],
        available_gpus=AVAILABLE_GPUS,
    ...
    Stage(
        lm_configs=[
            LMConfig(
                ...
                out_model='CheckClaimsMMLongDoc',
                system_template_path='distilabel/prompts/lc_sft/check_claims_mm_long_doc.txt',
