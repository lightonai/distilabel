...
def run_pipeline(config: Config):
    ...
    with Pipeline(
        ...
        q_req_branch = NoOp(name='q_req_branch', input_batch_size=32)
        ...
        collect_sp_answers = NoOp(name='collect_sp_answers', input_batch_size=32)
        ...
        break_up_collect_sp_answers_and_q_req = NoOp(name='break_up_collect_sp_answers_and_q_req', input_batch_size=32)
        ...
        rejoin_pages = Rejoin(name='rejoin_pages', input_col='source', keep_as_list_cols={'question_fully_answered', 'sp_answer'}, input_batch_size=32)
        ...
        (
            ...
            >> final_answer_router >> generate_answers >> collect_answers
        )
    ...
    distiset = pipeline.run(
        load_groups=(
            ...
            pipe_utils.steps_to_load_groups(
                [drop_poor_questions, *generate_answers, collect_answers],
                len(stage.available_gpus),
            )
        ),
        use_cache=True,
